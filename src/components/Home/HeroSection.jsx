    ...
    >
      ...
      <div className="relative z-10 text-center text-white mx-auto px-4">
        ...
        <div className="flex justify-center gap-4">
          <a
            href="#latest-posts"
            className="bg-primary hover:bg-secondary text-white font-semibold px-6 py-3 rounded-full"
          >
            Son Yazıları Keşfet
          </a>
          ...
          <a
            href="#categories"
            className="bg-transparent border-2 border-primary text-primary hover:bg-primary hover:text-white font-semibold px-6 py-3 rounded-full"
          >
            Kategorilere Göz At
          </a>
        </div>
